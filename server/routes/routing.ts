...
// every SIDECLAW_MODEL_*/SIDECLAW_BACKEND_*/SIDECLAW_THINKING_TOKENS_* override that was
// applied or refused. Read-only; what an operator checks after flipping an env var and
// running `make reload`.
